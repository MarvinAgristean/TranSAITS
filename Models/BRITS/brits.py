...
from Utils.metric_service import masked_mae_cal
# see brits.py in the github repository of the SAITS paper https://github.com/WenjieDu/SAITS
        ...
        """
            ...
            ----------
                ...
                imputed_data: 3 dimensional torch tensor, same shape as input X
                     the imputed data
                tuple containing:
                    imputed_data_f: 3 dimensional torch tensor, same shape as input X
                        imputed data of the forward rits model
                    imputed_data_b: 3 dimensional torch tensor, same shape as input X
                        imputed data of the backwards rits model
                """
              ...
              ----------
                  ...
                  ret: dictionary containing:
                        imputed_data: 3 dimensional torch tensor, same shape as input X
                            the imputed data
                        consistency_loss:
                            consistency loss of the forward and backward imputation
                        reconstruction_loss:
