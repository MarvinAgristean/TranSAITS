...
# see layers.py in SAITS paper https://github.com/WenjieDu/SAITS
...
class EncoderLayer(nn.Module):
    def __init__(self, d_time, d_feature, d_model, d_inner, n_head, d_k, d_v, diagonal_attention_mask,device, dropout=0.1,
                 attn_dropout=0.1):
